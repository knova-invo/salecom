...
import { getCountPayoutsTable, getPayoutsTable } from '../clients/payout.client';
...
function Payouts() {
	...
	const reviews = createQuery(() => getPayoutsTable(page(), search()));
	const countReviews = createQuery(() => getCountPayoutsTable(search()));
				...
				<Switch>
					...
					<Match when={reviews.isSuccess && countReviews.isSuccess}>
						<div class='w-full md:w-1/2 md:mx-auto'>
							<PayoutsTable payouts={reviews.data} />
